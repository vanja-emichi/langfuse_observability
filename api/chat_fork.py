"""
Chat fork API handler for the observability plugin.
...
class ChatFork(ApiHandler):
    async def process(self, input: Input, request: Request) -> Output:
        ...
        try:
            new_context = _fork_context(source, fork_at_log_no=fork_at_log_no)
...
def _fork_context(source_context: AgentContext, fork_at_log_no=None):
