...
**1. Fetch the guide in this blogpost** via `code_execution_tool` (terminal) or `browser`:

https://langfuse.com/guides/cookbook/error-analysis-llm-applications.md

If fetch is not available, use `search_engine` to query for langfuse.com error analysis guide.
